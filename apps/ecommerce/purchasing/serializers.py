...
class ReceiveItemsSerializer(serializers.Serializer):
    ...
    def validate_received_items(self, value):
        ...
        return value
# Agregar estos serializers en apps/ecommerce/purchasing/serializers.py

from rest_framework import serializers
from django.contrib.auth.models import User

# ✅ Serializer para acciones de la orden
...
# ✅ Serializer para opciones de duplicación
...
# ✅ Serializer para historial de la orden
...
# ✅ Actualizar el serializer principal para incluir historial
class PurchaseOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'po_number', 'supplier', 'supplier_name', 'supplier_contact',
            'supplier_email', 'supplier_phone', 'status', 'order_date',
            'expected_delivery', 'subtotal', 'tax_amount', 'total_amount',
            'notes', 'created_at', 'updated_at', 'created_by', 'created_by_name',
            'created_by_full_name', 'items', 'items_count', 'completion_percentage',
            'pending_items_count', 'can_edit', 'can_cancel', 'can_duplicate',
            'can_send_reminder', 'history'
        ]
    ...
    def get_history(self, obj):
        ...
        try:
            ...
            # Si hay un modelo de historial separado
            # history_qs = obj.history_entries.all().order_by('-created_at')
            # return PurchaseOrderHistorySerializer(history_qs, many=True).data
...
# ✅ Serializer específico para exportar PDF
class PurchaseOrderPDFSerializer(serializers.ModelSerializer):
    ...
    def get_supplier_info(self, obj):
        return {
            ...
            'phone': obj.supplier.phone if obj.supplier else '',
...
# ✅ Serializer para respuesta de acciones exitosas
